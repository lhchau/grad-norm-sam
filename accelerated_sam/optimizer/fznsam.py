...
class FZNSAM(torch.optim.Optimizer):
    def __init__(self, params, base_optimizer, rho=0.05, alpha=1, adaptive=False, **kwargs):
        assert rho >= 0.0, f"Invalid rho, should be non-negative: {rho}"

        defaults = dict(rho=rho, adaptive=adaptive, **kwargs)
        super(FZNSAM, self).__init__(params, defaults)
